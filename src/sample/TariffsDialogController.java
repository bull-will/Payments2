...
public class TariffsDialogController {
    ...
    public void obtainNumbersFromTextFields() {
        ...
        if (someFieldsProcessedWrong) {
            ...
            Alerts.alertInfo("Платеж(и) обработан(ы) неправильно", "Значения в одном (или нескольких) полях ввода тарифов некорректны.\n" +
                    "Всё неправильное замененно значением 0");
        }
    }
